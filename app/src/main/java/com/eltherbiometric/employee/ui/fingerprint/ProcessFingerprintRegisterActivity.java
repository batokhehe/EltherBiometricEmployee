...
import com.eltherbiometric.employee.ui.registration.FingerPrintActivity;
...
public class ProcessFingerprintRegisterActivity extends Activity {
    ...
    private void buttonSave_OnClick(View view) {
        com.eltherbiometric.employee.ui.registration.FingerPrintActivity.addProcessedImage(matResult, nik);
    }
    ...
    private void initialize() {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                services.Save(nik, name, username, password, division);
                Intent intent = new Intent(ProcessFingerprintRegisterActivity.this, LoginActivity.class);
