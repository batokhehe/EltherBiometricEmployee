...
package com.eltherbiometric.employee.ui.facerecog;
...
import com.eltherbiometric.employee.ui.registration.FaceRecognitionActivity;

import java.util.Locale;


public class SeekBarArrows extends LinearLayout implements SeekBar.OnSeekBarChangeListener {
    private static final String TAG = FaceRecognitionActivity.class.getSimpleName() + "/" + SeekBarArrows.class.getSimpleName();
    ...
    private class OnArrowListener implements OnClickListener, OnLongClickListener, OnTouchListener {
