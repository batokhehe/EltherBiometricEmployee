...
package com.eltherbiometric.employee.ui.presence;
...
import com.eltherbiometric.employee.ui.facerecog.CameraBridgeViewBase;
import com.eltherbiometric.employee.ui.facerecog.NativeMethods;
import com.eltherbiometric.employee.ui.facerecog.SeekBarArrows;
import com.eltherbiometric.employee.ui.facerecog.TinyDB;
import com.eltherbiometric.employee.utils.Utility;
...
public class FaceRecognitionActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2, GoogleApiClient.ConnectionCallbacks,
    ...
    private void showAlert(final String message, String method, final int param) {
        if(method.equals("face_detected")) {
            ...
            if (user_.getNik().equals(imagesLabels.get(param))) {
...
//            mTrainFacesTask.cancel(true);
    ...
    private void showLabelsDialog() {
        ...
        if (!uniqueLabelsSet.isEmpty()) { // Make sure that there are any labels
            ...
            final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(FaceRecognitionActivity.this, android.R.layout.simple_list_item_1, uniqueLabels) {
                @Override
                public @NonNull
            ...
            ListView mListView = new ListView(FaceRecognitionActivity.this);
