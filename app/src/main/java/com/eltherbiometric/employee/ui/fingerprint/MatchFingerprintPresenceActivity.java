 ...
 */
public class MatchFingerprintPresenceActivity extends Activity {
    ...
    public MatchFingerprintPresenceActivity() {
...
//        this.startActivity(intent);
    ...
    private void processMatching() {
        ...
        int count = FingerPrintActivity.processedImageCount();
        Object[] names = FingerPrintActivity.getProcessedImageNames();
        final HashMap<String, Integer> scores = new HashMap<String, Integer>(count);
        int[] scoreValues = new int[count];
        int maxIndex = 0;
        for (int i = 0; i < count; i++) {
            scoreValues[i] = matching(MatQuery, FingerPrintActivity.getProcessedImage(i));
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Intent intent = new Intent(MatchFingerprintPresenceActivity.this, ResultActivity.class);
                        MatchFingerprintPresenceActivity.this.startActivity(intent);
                    }
                })
