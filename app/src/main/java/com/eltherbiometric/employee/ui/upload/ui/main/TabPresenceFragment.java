...
public class TabPresenceFragment extends Fragment {
    private TabPresenceAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dataList.clear();
        dataList.addAll(services.AllPresence());
        adapter = new TabPresenceAdapter(dataList, getContext());
