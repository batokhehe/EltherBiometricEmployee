...
public class NativeMethods {
    private static final String TAG = FaceRecognitionActivity.class.getSimpleName() + "/" + NativeMethods.class.getSimpleName();
    ...
    public static class TrainFacesTask extends AsyncTask<Void, Void, Boolean> {
         ...
         */
        public TrainFacesTask(Mat images, Callback callback) {
